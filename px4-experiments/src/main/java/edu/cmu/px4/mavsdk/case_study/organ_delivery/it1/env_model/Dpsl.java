...
// test the STLEncoder
package edu.cmu.px4.mavsdk.case_study.organ_delivery.it1.env_model;
...
public class Dpsl {
    ...
    public static void run() {
        // STL requirements
        String stl = testDir + "organ_delivery/dpsl.stl";

        // environmental model for delivery planning feature
        String dp_env = testDir + "organ_delivery/delivery_planning.mzn";

        // environmental model for safe landing feature
        String sl_env = testDir + "organ_delivery/safe_landing.mzn";
