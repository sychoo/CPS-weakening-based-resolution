...
package edu.cmu.px4.mavsdk.case_study.organ_delivery.main.speed_battery_model;
...
// initialize STLEncoder with parameter passing
    ...
    public static String testDir = "src/main/java/edu/cmu/px4/mavsdk/case_study/organ_delivery/main/speed_battery_model/";

    public static void runSimpleModel() {
        String stl = testDir + "dpsl.stl";
        String env = testDir + "new_model.mzn";
