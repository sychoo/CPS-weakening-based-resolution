...
# df = pd.read_csv("data10-romulo-partial.csv")
df = pd.read_csv("data10-romulo-partial-redacted.csv")
print(df.head())
...
valor_plot = sns.barplot(
    ...
    #  y= 'average_robustness_sum',
     y= 'average_robustness_sum_minus5',
    ...
    # y = 'runaway_average_robustness_minus5',
