...
count=2
# 150 seconds for the simulator to run
# for i in {1..5}
...
do
  ...
  # 50 seconds
    ...
    gtimeout 140 mvn exec:java -Dexec.mainClass="edu.cmu.px4.mavsdk.case_study.boundary_runaway.main.BoundaryRunawayMain"; sleep 30
